...
git config --global alias.dh 'd HEAD'
git config --global alias.dm 'd master'
git config --global alias.dsh 'd --stat HEAD'
git config --global alias.dsm 'd --stat master'
...
git config --global alias.emailbb 'config --local user.email Ryan.Clarke@blackboard.com'
